...
public class BSONFileInputFormatGeneric<K,V> extends FileInputFormat<K,V> {

    private static final Log LOG = LogFactory.getLog(BSONFileInputFormatGeneric.class);
